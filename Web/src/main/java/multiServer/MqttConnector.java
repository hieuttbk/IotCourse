...
public static void main(String[] args) {
    new MqttConnector().doDemo();
}

public void doDemo() {
    try {
    	System.out.println("> MqttConnector: Subcribe MQTT topic " + topic);
...
//        message.setPayload("\"{\\\"name\\\":\\\"mqttNode1\\\",\\\"value\\\":\\\"27\\\"}\""
//                .getBytes());
...
public void messageArrived(String topic, MqttMessage message)
        throws Exception {
 System.out.println("> MqttConnector: request: " + message);   
}
